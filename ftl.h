...
#define NUM_DATA_BLKS 		((NUM_LPAGES + PAGES_PER_BLK -1)/PAGES_PER_BLK)
...
+ SCAN_LIST_BYTES + BLK_MAP_BYTES+LOG_MAP_BYTES)
...
#define LOG_MAP_BYTES 		((NUM_LOG_BLKS*PAGES_PER_BLK * sizeof(UINT32) + BYTES_PER_SECTOR - 1) / BYTES_PER_SECTOR * BYTES_PER_SECTOR)
///////////////////////////////
